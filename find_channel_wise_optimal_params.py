...
if __name__ == "__main__":
    ...
    gabor_parameters_list = [
        ...
        [[   0, -1.03,        90,  0.33,    1.0,    8.25,     0,     0]],
        [[1.33,     0,        90,  1.10,   1.47,    9.25,     0,     0]],
        [[   0,     0,        90,   0.3,   0.86,   11.60,  0.61,     0]],
        [[   0,     0,        90,  0.29,    0.8,    4.17,  1.03,   0.1],
         [   0,     0,        90,  0.53,    0.8,    4.74,  0.81,  0.17],
         [   0,     0,        90,  0.27,    0.8,    4.39,  0.73,  0.17]],
        [[   0,     0,        90, -0.33,   0.80,   20.19,     0,     0]],
        [[   0,     0,        90,  0.29,   1.30,    4.17,  0.73,  0.15],
         [   0,     0,        90,  0.53,   1.30,    4.74,  0.81,  0.17],
         [   0,     0,        90,  0.27,   1.30,    4.39,  1.03,  0.17]],
        [[   0,     1,        90,  0.33,    2.0,    8.25,     0,     0]],
        [[   0,     1,        90, -0.33,   0.80,   20.19,     0,     0]],
        [[   0,     1,        90,   0.3,   0.86,    8.60, -0.61,     0]],
        [[   0,     0,        90, -0.46,    0.9,      25,     1,     0]]
    ]
