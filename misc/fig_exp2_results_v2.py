...
if __name__ == '__main__':
    ...
    ax1.plot(model_base_time_results[:, 0], model_base_time_results[:, 2], label='model')
    ax1.plot(control_base_time_results[:, 0], control_base_time_results[:, 2], label='control')
    ax1.plot(model_3x3_time_results[:, 0], model_3x3_time_results[:, 2], label='model_3x3')
    ax1.plot(control_3x3_time_results[:, 0], control_3x3_time_results[:, 2], label='control_3x3')

    ax1.text(0, 0.445, 'A', fontsize=30)
