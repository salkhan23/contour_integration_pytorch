...
# Dir: results/edge_detection/EdgeDetectionResnet50_CurrentSubtractInhibitLayer_20200307_163445_lateral_7x7
EdgeDetectionCSIResnet50_2_post_layers_lateral_7x7 = np.array([
    [0, 0.2197, 0.3883, 0.0703, 0.6810, 0.001],
    [1, 0.0535, 0.7057, 0.0428, 0.7420, 0.001],
    [2, 0.0403, 0.7420, 0.0380, 0.7617, 0.001],
    [3, 0.0368, 0.7594, 0.0351, 0.7753, 0.001],
    [4, 0.0358, 0.7651, 0.0341, 0.7792, 0.001],
    [5, 0.0338, 0.7758, 0.0325, 0.7873, 0.001],
    [6, 0.0325, 0.7824, 0.0310, 0.7949, 0.001],
    [7, 0.0317, 0.7871, 0.0305, 0.7962, 0.001],
    [8, 0.0309, 0.7915, 0.0297, 0.8010, 0.001],
    [9, 0.0303, 0.7948, 0.0293, 0.8034, 0.001],
    [10, 0.0298, 0.7979, 0.0288, 0.8061, 0.001],
    [11, 0.0294, 0.8004, 0.0286, 0.8074, 0.001],
    [12, 0.0290, 0.8025, 0.0288, 0.8048, 0.001],
    [13, 0.0287, 0.8045, 0.0282, 0.8090, 0.001],
    [14, 0.0285, 0.8059, 0.0276, 0.8144, 0.001],
    [15, 0.0282, 0.8076, 0.0275, 0.8141, 0.001],
    [16, 0.0281, 0.8080, 0.0269, 0.8200, 0.001],
    [17, 0.0278, 0.8101, 0.0269, 0.8189, 0.001],
    [18, 0.0276, 0.8110, 0.0267, 0.8202, 0.001],
    [19, 0.0275, 0.8119, 0.0264, 0.8224, 0.001],
    [20, 0.0274, 0.8128, 0.0263, 0.8226, 0.001],
    [21, 0.0272, 0.8138, 0.0262, 0.8228, 0.001],
    [22, 0.0271, 0.8143, 0.0261, 0.8244, 0.001],
    [23, 0.0270, 0.8151, 0.0260, 0.8244, 0.001],
    [24, 0.0269, 0.8158, 0.0260, 0.8244, 0.001],
    [25, 0.0268, 0.8161, 0.0259, 0.8253, 0.001],
    [26, 0.0267, 0.8168, 0.0258, 0.8254, 0.001],
    [27, 0.0267, 0.8172, 0.0258, 0.8257, 0.001],
    [28, 0.0266, 0.8177, 0.0257, 0.8262, 0.001],
    [29, 0.0265, 0.8183, 0.0256, 0.8270, 0.001],
    [30, 0.0264, 0.8187, 0.0255, 0.8273, 0.001],
    [31, 0.0248, 0.8299, 0.0242, 0.8359, 0.0001],
    [32, 0.0247, 0.8303, 0.0241, 0.8362, 0.0001],
    [33, 0.0247, 0.8304, 0.0241, 0.8364, 0.0001],
    [34, 0.0246, 0.8306, 0.0241, 0.8366, 0.0001],
    [35, 0.0246, 0.8309, 0.0240, 0.8368, 0.0001],
    [36, 0.0245, 0.8311, 0.0240, 0.8370, 0.0001],
    [37, 0.0245, 0.8313, 0.0240, 0.8371, 0.0001],
    [38, 0.0245, 0.8315, 0.0239, 0.8373, 0.0001],
    [39, 0.0244, 0.8316, 0.0239, 0.8375, 0.0001],
    [40, 0.0244, 0.8318, 0.0239, 0.8376, 0.0001],
    [41, 0.0244, 0.8319, 0.0238, 0.8377, 0.0001],
    [42, 0.0243, 0.8321, 0.0238, 0.8379, 0.0001],
    [43, 0.0243, 0.8322, 0.0238, 0.8380, 0.0001],
    [44, 0.0243, 0.8324, 0.0238, 0.8381, 0.0001],
    [45, 0.0243, 0.8325, 0.0237, 0.8383, 0.0001],
    [46, 0.0242, 0.8326, 0.0237, 0.8384, 0.0001],
    [47, 0.0242, 0.8328, 0.0237, 0.8385, 0.0001],
    [48, 0.0242, 0.8329, 0.0237, 0.8386, 0.0001],
    [49, 0.0242, 0.8330, 0.0236, 0.8388, 0.0001],
])

# Dir: results/edge_detection/EdgeDetectionResnet50_CurrentSubtractInhibitLayer_20200307_213109_lateral_3x3
EdgeDetectionCSIResnet50_2_post_layers_lateral_3x3 = np.array([
    [0, 0.2301, 0.4643, 0.0638, 0.6958, 0.001],
    [1, 0.0494, 0.7186, 0.0408, 0.7409, 0.001],
    [2, 0.0387, 0.7486, 0.0360, 0.7560, 0.001],
    [3, 0.0348, 0.7640, 0.0331, 0.7715, 0.001],
    [4, 0.0327, 0.7740, 0.0313, 0.7811, 0.001],
    [5, 0.0313, 0.7812, 0.0301, 0.7863, 0.001],
    [6, 0.0302, 0.7867, 0.0294, 0.7892, 0.001],
    [7, 0.0295, 0.7910, 0.0288, 0.7919, 0.001],
    [8, 0.0288, 0.7947, 0.0284, 0.7947, 0.001],
    [9, 0.0283, 0.7977, 0.0280, 0.7979, 0.001],
    [10, 0.0279, 0.8003, 0.0278, 0.8000, 0.001],
    [11, 0.0276, 0.8025, 0.0275, 0.8019, 0.001],
    [12, 0.0273, 0.8045, 0.0273, 0.8038, 0.001],
    [13, 0.0270, 0.8061, 0.0270, 0.8053, 0.001],
    [14, 0.0268, 0.8076, 0.0268, 0.8073, 0.001],
    [15, 0.0266, 0.8088, 0.0266, 0.8089, 0.001],
    [16, 0.0264, 0.8099, 0.0264, 0.8098, 0.001],
    [17, 0.0263, 0.8108, 0.0264, 0.8101, 0.001],
    [18, 0.0261, 0.8118, 0.0261, 0.8122, 0.001],
    [19, 0.0260, 0.8127, 0.0260, 0.8130, 0.001],
    [20, 0.0259, 0.8135, 0.0258, 0.8148, 0.001],
    [21, 0.0258, 0.8143, 0.0256, 0.8164, 0.001],
    [22, 0.0256, 0.8150, 0.0254, 0.8177, 0.001],
    [23, 0.0255, 0.8157, 0.0253, 0.8185, 0.001],
    [24, 0.0254, 0.8163, 0.0252, 0.8194, 0.001],
    [25, 0.0254, 0.8170, 0.0252, 0.8197, 0.001],
    [26, 0.0253, 0.8175, 0.0251, 0.8198, 0.001],
    [27, 0.0252, 0.8181, 0.0250, 0.8204, 0.001],
    [28, 0.0251, 0.8186, 0.0250, 0.8204, 0.001],
    [29, 0.0250, 0.8192, 0.0249, 0.8209, 0.001],
    [30, 0.0249, 0.8197, 0.0249, 0.8213, 0.001],
    [31, 0.0239, 0.8267, 0.0238, 0.8283, 0.0001],
    [32, 0.0239, 0.8268, 0.0238, 0.8276, 0.0001],
    [33, 0.0239, 0.8269, 0.0238, 0.8273, 0.0001],
    [34, 0.0239, 0.8270, 0.0238, 0.8272, 0.0001],
    [35, 0.0238, 0.8272, 0.0238, 0.8271, 0.0001],
    [36, 0.0238, 0.8273, 0.0238, 0.8271, 0.0001],
    [37, 0.0238, 0.8274, 0.0238, 0.8272, 0.0001],
    [38, 0.0238, 0.8275, 0.0238, 0.8272, 0.0001],
    [39, 0.0238, 0.8277, 0.0237, 0.8272, 0.0001],
    [40, 0.0237, 0.8278, 0.0237, 0.8272, 0.0001],
    [41, 0.0237, 0.8279, 0.0237, 0.8272, 0.0001],
    [42, 0.0237, 0.8280, 0.0237, 0.8273, 0.0001],
    [43, 0.0237, 0.8281, 0.0237, 0.8273, 0.0001],
    [44, 0.0237, 0.8282, 0.0237, 0.8273, 0.0001],
    [45, 0.0237, 0.8283, 0.0237, 0.8274, 0.0001],
    [46, 0.0236, 0.8284, 0.0237, 0.8274, 0.0001],
    [47, 0.0236, 0.8285, 0.0237, 0.8274, 0.0001],
    [48, 0.0236, 0.8285, 0.0237, 0.8275, 0.0001],
    [49, 0.0236, 0.8286, 0.0237, 0.8275, 0.0001],
])
...
if __name__ == "__main__":
    ...
    # Different RF Sizes
    plt.plot(
        EdgeDetectionCSIResnet50_2_post_layers_lateral_7x7[:, 0],
        EdgeDetectionCSIResnet50_2_post_layers_lateral_7x7[:, 2],
        label='train_2_post_layers_7x7',
        linestyle='--',
        color='red',
        marker='o'
    )
    plt.plot(
        EdgeDetectionCSIResnet50_2_post_layers_lateral_7x7[:, 0],
        EdgeDetectionCSIResnet50_2_post_layers_lateral_7x7[:, 4],
        label='val_2_post_layers_7x7',
        linestyle='-',
        color='red',
        marker='o'
    )
    ...
    plt.plot(
        EdgeDetectionCSIResnet50_2_post_layers_lateral_3x3[:, 0],
        EdgeDetectionCSIResnet50_2_post_layers_lateral_3x3[:, 2],
        label='train_2_post_layers_3x3',
        linestyle='--',
        color='green',
        marker='x'
    )
    plt.plot(
        EdgeDetectionCSIResnet50_2_post_layers_lateral_3x3[:, 0],
        EdgeDetectionCSIResnet50_2_post_layers_lateral_3x3[:, 4],
        label='val_2_post_layers_3x3',
        linestyle='-',
        color='green',
        marker='x'
    )
