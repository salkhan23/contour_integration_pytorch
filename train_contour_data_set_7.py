# ------------------------------------------------------------------------------------
# Similar to train_contour_data_set_5 but refactored. Objective is to combine all
# different training scripts. Need to validate first
#
# Similar to train_contour_data_set_3.py but with additional constraint of only
# positive lateral weights. Currently this is enforced by setting all negative
# weights to zero after every epoch
#
